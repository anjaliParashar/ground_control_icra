...
if (TensorRT_FOUND)
    ...
    if (NOT TARGET TensorRT::ONNXParser)
        ...
        set_property(TARGET TensorRT::ONNXParser APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_onnx_parser_LIBRARY}")
    endif ()

    if (NOT TARGET TensorRT::CaffeParser)
        add_library(TensorRT::CaffeParser UNKNOWN IMPORTED)
        set_property(TARGET TensorRT::CaffeParser APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_caffe_parser_LIBRARY}")
    endif ()

    if (NOT TARGET TensorRT::TensorRTCore)
        add_library(TensorRT::TensorRTCore UNKNOWN IMPORTED)
        set_property(TARGET TensorRT::TensorRTCore APPEND PROPERTY IMPORTED_LOCATION "${TensorRT_LIBRARY}")
    endif ()
    ...
    if (NOT TARGET TensorRT::TensorRT)
        ...
        target_link_libraries(TensorRT::TensorRT INTERFACE TensorRT::TensorRTCore TensorRT::ONNXParser TensorRT::CaffeParser)
    endif ()
