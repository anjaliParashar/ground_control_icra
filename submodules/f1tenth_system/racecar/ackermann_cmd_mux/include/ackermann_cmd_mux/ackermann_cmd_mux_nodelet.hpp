...
private:
  ...
  void ackermannCmdCallback(const f1tenth_msgs::F1TenthDriveStamped::ConstPtr& msg, unsigned int idx);
  ...
  **********************/
  ...
  public:
    ...
    void operator()(const f1tenth_msgs::F1TenthDriveStamped::ConstPtr& msg)
    {
